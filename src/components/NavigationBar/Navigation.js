    ...
    <header>
      <div className="logo-container">
        <img
          ...
          alt=""
        /><h2>React<span>Practices</span></h2>
      </div>
      <nav className={`${navigationActive ? 'active' : ''}`}>
        <svg
          className="close"
          width="33"
          height="33"
      ...
      <svg className="menu" onClick={toggleNavigation} width="48" height="32" viewBox="0 0 48 32" fill="none"
        xmlns="http://www.w3.org/2000/svg">
